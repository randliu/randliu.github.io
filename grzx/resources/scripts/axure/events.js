...
$axure.internal(function($ax) {
    ...
    var _handleEvent = $ax.event.handleEvent = function(elementId, eventInfo, axEventObject, skipShowDescriptions, synthetic) {
        ...
        if(!synthetic && currentEvent && currentEvent.handled && !eventInfo.isMasterEvent) return;
        ...
        if(currentEvent) {
            currentEvent.handled = !synthetic && !bubble && eventDescription != 'OnFocus' && eventDescription != 'OnResize';
